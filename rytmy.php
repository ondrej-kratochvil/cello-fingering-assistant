...
<?php require __DIR__ . '/assets/partials/tool_intro.php'; ?>
            ...
            <div id="rhythmsContent" class="hidden space-y-6">
                <div class="flex flex-wrap items-center gap-3">
                    <label class="block text-sm font-bold text-slate-700" data-i18n="rhythms.pattern">Rytmický pattern:</label>
                    <select id="rhythmPattern" class="p-3 border-2 border-slate-200 rounded-xl font-mono min-w-[200px]"></select>
                    <button type="button" id="rhythmNextBtn" class="bg-slate-200 hover:bg-slate-300 text-slate-800 font-bold py-2 px-4 rounded-xl" data-i18n="rhythms.next">Další</button>
                    <button type="button" id="rhythmRandomBtn" class="bg-slate-200 hover:bg-slate-300 text-slate-800 font-bold py-2 px-4 rounded-xl" data-i18n="rhythms.random">Náhodný</button>
                </div>
