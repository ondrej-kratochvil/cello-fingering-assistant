...
?>
        <main class="p-8 bg-white">
            ...
            <p class="text-slate-600 mb-6" data-i18n="bowing.intro">Načte sekvenci z nástroje Prstoklad a aplikuje na ni zvolený smykový pattern (legato = oblouček, samostatně = bez úpravy).</p>
